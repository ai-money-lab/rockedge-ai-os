...
GMAIL_TOKEN_JSON  = os.environ["GMAIL_TOKEN_JSON"]   # GitHub Secret に JSON 文字列で保存
...
{chr(10).join(f'- ⚡ {item}' for item in a.get('urgent_items', [])) or '_なし_'}
